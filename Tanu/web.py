  ...
  <body>
    ...
    <html>
      <head>
        ...
        <script
          src="https://kit.fontawesome.com/b6fe3b813e.js"
      ...
      <body>
        <button
          class="tablink"
          onclick="openPage('explore', this, '#06A5FF')"
          id="defaultOpen"
        >
          <!-- HTML -->
        ...
        <button class="tablink" onclick="openPage('train', this, '#C387FF')">
          Train <i class="fa-solid fa-code-branch"></i>
        </button>
        <button class="tablink" onclick="openPage('play', this, '#4ACB67')">
        ...
        <div id="train_test_button" class="tabcontent">
          <h2>
            ...
            <!-- <button class="button button2" type="button">-</button> -->
          </h2>
        </div>
        ...
        <div id="tablePlay" class="tabcontent">
          <h3>Training Values</h3>
          <table id="myTable" class="center">
            <thead>
              <th>Sensor Value</th>
        ...
        <!-- JAVASCRIPT -->
        <script>
          // this graph was hard coded by Jennifer Cross, might be hard to add
          const sensor_array = [];
          const motor_array = [];
          var g;
          ...
          class Graph {
            ...
            convert_y(y) {
              ...
              var cy =
                ((this.bh - this.start * 2) * (180 - y)) / 180 + this.start;
              return cy;
            }
          ...
          function openPage(pageName, elmnt, color) {
            ...
            if (pageName == "train") {
              ...
              stop();
              document.getElementById("train_test_button").style.display =
                "block";
          ...
          // sends sensor data from microcontroller
          ...
          function addvalue(firstPageLoad, motor, sensor) {
            if (firstPageLoad) {
              ...
              xhttp.open(
                "GET",
                "/?addvalue=" + sliderValue + "=" + sensorValue,
                true
              );
              xhttp.send();
            }
          ...
          function deletevalue(r) {
            ...
            if (rowCount > 1) {
              ...
              //send request to main.py to delete value
              //subtracts 1 to account for table header
              var xhttp = new XMLHttpRequest();
          ...
          function test() {
            ...
            if (button_text == "Play!") {
              ...
              document.getElementById("toggle_play").style.backgroundColor =
                "#FF5151";
              var xhttp = new XMLHttpRequest();
